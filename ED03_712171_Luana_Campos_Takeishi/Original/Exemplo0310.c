/*
    Exemplo0310 - Versao 0.1 - 31/08/2020
    Author: Luana Campos Takeishi
    Matr'icula: 712171

    Para compilar em terminal (janela de comandos):
    Linux:      gcc -o exemplo0310      exemplo0310.c
    Windows:    gcc -o exemplo0310.exe  exemplo0310.c
...
condicao para o superior ser maior que inferior e o passo ser maior que zero
alteracoes:
"superior = IO_readdouble" (estava como IO_readint)
erro: estava em loop infinito (a entrada do superior)
obs: para a opcao c.) em que inferior>superior requer a entrada de
dados ate que o superior seja maior que
---------------------------------------------- previsao de testes
a.) [ 0.0 : 5   ] e passo =  0.2
...
Versao Teste
 ...
 0.8    01. ( OK ) metodos e contagem a partir de intervalos (crescente)
 0.9    01. ( OK ) metodos e contagem a partir de intervalos (decrescente)
 1.0    01. ( OK ) metodos e contagem com repeticao e confirmacao
*/