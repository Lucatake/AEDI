/*
    Exemplo0309 - Versao 0.1 - 31/08/2020
    Author: Luana Campos Takeishi
    Matr'icula: 712171

    Para compilar em terminal (janela de comandos):
    Linux:      gcc -o exemplo0309      exemplo0309.c
    Windows:    gcc -o exemplo0309.exe  exemplo0309.c
...
o programa conta de forma decrescente a partir de um intervalo 
e de acordo com um passo determinado
obs: com o passo negativo, o programa conta infinito
---------------------------------------------- previsao de testes
a.)  0 e 1, passo  1
b.)  1 e 5, passo  1
c.)  1 e 5, passo  2
