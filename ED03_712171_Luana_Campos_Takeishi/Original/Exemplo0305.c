/*
    Exemplo0305 - Versao 0.1 - 31/08/2020
    Author: Luana Campos Takeishi
    Matr'icula: 712171

    Para compilar em terminal (janela de comandos):
    Linux:      gcc -o exemplo0305      exemplo0305.c
    Windows:    gcc -o exemplo0305.exe  exemplo0305.c
