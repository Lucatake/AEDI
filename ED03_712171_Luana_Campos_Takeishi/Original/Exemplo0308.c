/*
    Exemplo0308 - Versao 0.1 - 31/08/2020
    Author: Luana Campos Takeishi
    Matr'icula: 712171

    Para compilar em terminal (janela de comandos):
    Linux:      gcc -o exemplo0308      exemplo0308.c
    Windows:    gcc -o exemplo0308.exe  exemplo0308.c
...
o programa conta de forma crescente a partir de um intervalo
---------------------------------------------- previsao de testes
a.) 0 e 1
b.) 1 e 5
c.) 3 e 5
