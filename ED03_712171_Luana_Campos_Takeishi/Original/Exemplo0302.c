/*
    Exemplo0302 - Versao 0.1 - 31/08/2020
    Author: Luana Campos Takeishi
    Matr'icula: 712171

    Para compilar em terminal (janela de comandos):
    Linux:      gcc -o exemplo0302      exemplo0302.c
    Windows:    gcc -o exemplo0302.exe  exemplo0302.c
...
o programa conta o numero pela sua quantidade (repetindo-o)
para valores negativos, nao funciona
