/*
    Exemplo0217 - Versao 0.1 - 27/08/2020
...
void valueIoP ( int ip1, int ip2 )
{
    ...
    if ( (t1 == 1) && (t2 == 0) && (ip1 > 0) && (ip2 < 0) ) 
    {
        ...
        IO_printf("\nValor 01 - (%d) e' impar positivo e valor 02 - (%d) e' par negativo", ip1, ip2);
    } 
    else
    {
...
dizer se o primeiro e impar e positivo, 
e se o segundo e par e negativo
