/*
Exemplo0510 - v0.1. - 18/09/2020
Aluna: Luana Campos Takeishi
Matricula: 712171
*/
...
/**
somarFracao07 - funcao para somar certa quantidade de fracoes.
@return soma dos valores
@param x - quantidade de valores a serem mostrados
*/
double somarFracao07(int x)
{
    // definir dados locais
    double soma = 1.0;
    double numerador = 0;
...
int main()
{
    ...
    do
    {
        ...
        IO_println(" 6 - mostrar certa quantidade de valores pares e sua soma");
        IO_println(" 7 - mostrar certa quantidade de fraacoes e sua soma");
        IO_println(" 8 - funcao para somar certa quantidade de fracoes");
        IO_println(" 9 - funcao para somar certa quantidade de fracoes");
        IO_println("10 - funcao para multiplicar certa quantidade de valores pares.");
        IO_println("");
...
0.2  01. ( OK ) mostrar certa quantidade de valores pares.
0.3  01. ( OK ) mostrar certa quantidade de valores pares (alternativo).
0.4  01. ( OK ) mostrar certa quantidade de valores pares decrescente.
0.5  01. ( OK ) mostrar certa quantidade de valores pares decrescente (alternativo)
0.6  01. ( OK ) mostrar certa quantidade de valores pares e sua soma.
0.7  01. ( OK ) mostrar certa quantidade de fracoes e sua soma.
0.8  01. ( OK ) funcao para somar certa quantidade de fracoes.
0.9  01. ( OK ) funcao para somar certa quantidade de fracoes.
1.0  01. ( OK ) funcao para multiplicar certa quantidade de valores pares.
*/