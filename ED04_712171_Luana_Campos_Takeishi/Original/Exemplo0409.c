/*
    Exemplo0409 - Versao 0.1 - 11/09/2020
    Author: Luana Campos Takeishi
    Matr'icula: 712171

    Para compilar em terminal (janela de comandos):
    Linux:      gcc -o exemplo0409      exemplo0409.c
    Windows:    gcc -o exemplo0409.exe  exemplo0409.c
...
int main()
{
    ...
    do
    {
        ...
        IO_println(" 9 - ler cadeia de caracteres e contar os algarismos");
        IO_println("10 - ");
        IO_println("");
...
0.9 01. ( OK ) metodo para ler cadeia de caracteres e contar os algarismos
