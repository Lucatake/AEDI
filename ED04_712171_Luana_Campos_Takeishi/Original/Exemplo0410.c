/*
    Exemplo0410 - Versao 0.1 - 11/09/2020
    Author: Luana Campos Takeishi
    Matr'icula: 712171

    Para compilar em terminal (janela de comandos):
    Linux:      gcc -o exemplo0410      exemplo0410.c
    Windows:    gcc -o exemplo0410.exe  exemplo0410.c
...
int main()
{
    ...
    do
    {
        ...
        IO_println(" 9 - ler cadeia de caracteres, contar e mostrar os algarismos");
        IO_println("10 - ler cadeia de caracteres, contar e mostrar os algarismos (alternativo)");
        IO_println("");
...
0.6 01. ( OK ) metodo para ler palavra e contar letras minusculas
0.7 01. ( OK ) metodo para ler palavra, contar e mostrar letras minusculas
0.8 01. ( OK ) metodo para ler palavra, contar e mostrar letras minusculas (alternativo)
0.9 01. ( OK ) metodo para ler cadeia de caracteres, contar e mostrar os algarismos
1.0 01. ( OK ) metodo para ler cadeia de caracteres, contar e mostrar os algarismos (alternativo)
