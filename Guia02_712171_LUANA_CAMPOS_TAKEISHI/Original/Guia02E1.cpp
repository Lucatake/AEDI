/*
Guia_02E1 -v0.2. - 15 / 08 / 2020
Author: Luana Campos Takeishi
Matri'cula: 712171
Para compilar em uma janela de comandos (terminal):
No Linux:     gcc -o Guia02E1      ./Guia02E1.cpp
No Windows:   gcc -o Guia02E1.exe    Guia02E1.cpp
Para executar em uma janela de comandos (terminal):
No Linux:     ./Guia02E1.cpp
No Windows:     Guia02E1
*/
...
int main( )
{
    ...
    //executar tarefa
    robot->playActions( "Tarefa02E1.txt" );
    //contar as linhas do arquivo
    robot->countLine( "Tarefa02E1.txt" );   
...
instrucoes gerais:
contar e informar o número de comandos (linhas) em um arquivo contendo a descrição de uma tarefa
----------------------------------------------notas / observacoes / comentarios
mesmo percurso do Guia0215
----------------------------------------------previsao de testes
----------------------------------------------historico
Versao 1.0
