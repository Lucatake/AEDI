/**
    Exemplo0910 - Versao 0.1 - 19/10/2020
...
{
    // identificar
    IO_id("EXEMPLO0910 - Method10 - v0.1");
    // definir dados
    int matrix1[][2] = {{1, 2},
                        {3, 4}};
    int matrix2[][2] = {{1, 0},
...
int menu(void)
{
    ...
    IO_println("10 - Multiplicar matrizes com inteiros.");
    //ler do teclado
...
Exercicio Versao  Teste   Data    Descricao
 ...
 1.0       1.0   ( OK )  19/10    - Multiplicar matrizes com inteiros.
*/