/**
 * Exemplo0610 - Versao 0.1 - 28/09/2020
...
int main( )
{
    ...
    do
    {
        ...
        IO_println(" 9 - termos da sequencia de fibonacci (recursividade)");
        IO_println("10 - contar letras maiusculas na cadeia de caractreres (recursividade)");
...
Exercicio Versao Teste   Data    Descricao
 ...
 0.9       01.   ( OK )  28/09  - termos da sequencia de fibonacci (recursividade)
 1.0       01.   ( OK )  28/09  - contar letras maiusculas na cadeia de caractreres (recursividade)
*/