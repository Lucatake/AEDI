...
Versao 0.1
erro em: int quantidade = readCommands (comandos, "Tarefa0301.txt");
robot->doCommands(quantidade, commandos);
int comandos[COMMANDS]; em doTask( ) nao definido
Versao 0.2
solucao: adicionar  int comandos[MAX_COMMANDS];
Versao 0.3
retirada a funcao doTask() pois a mesma nao esta sendo utilizada e estava com erro
na variavel int comand[COMMANDS], sem essa funcao, funciona corretamente
---------------------------------------------- previsao de testes
