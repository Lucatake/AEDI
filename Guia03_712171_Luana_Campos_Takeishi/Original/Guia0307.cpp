...
Versao 0.1
adicionado mais de um marcador
erro: karel comecava virado para o norte e no conseguia mudar de linha
Versao 0.2
karel inicia virado para EAST
programa funcionou como o esperado, ele indica as posicoes dos marcadores
ao encontrar um e continua sua varredura
---------------------------------------------- previsao de testes
mostra o tamanho do mundo depois anda pelo mundo todo em busca dos marcadores
---------------------------------------------- historico
