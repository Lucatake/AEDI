...
Versao 0.2
solucao: declarar int comandos[MAX_COMMANDS]; e adicionar o robot->
---------------------------------------------- previsao de testes
...
0.3 02. ( OK ) teste receber comandos de arquivo
*/