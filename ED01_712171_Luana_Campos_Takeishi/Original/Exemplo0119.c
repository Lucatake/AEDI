/*
    Exemplo0119 - Versao 0.1 - 22/08/2020
...
int main (int argc, char* argv [ ])
{
    ...
    IO_id("Exemplo0119 - Programa = Versao0.1");

    //ler valores do teclado
    raio = IO_readfloat ("\nDigite um valor real: ");

    //definir raio com 1/5 de seu valor inicial
    raio = raio/5;
...
- supor que esse valor represente o raio de um circulo,
calcular e mostrar a area de um circulo com um quinto do raio.
DICA: Na biblioteca <math.h> ha definicao da constante equivalente a PI (M_PI).
